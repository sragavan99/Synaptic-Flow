...
def visualise_surviving_weights(wgt_mdl, mask_mdl=None, rescale=False, bins=50, layerwise=False):
...
def visualise(wgt_mdl=None, wgt_file=None, mask_mdl=None, mask_file=None, arch=None, rescale=False, bins=50, layerwise=False):
    if arch == 'vgg16-bn':
        if not wgt_mdl:
    ...
    visualise_surviving_weights(wgt_mdl, mask_mdl, rescale, bins, layerwise)